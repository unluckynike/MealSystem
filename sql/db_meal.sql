...
Source Database       : db_meal

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2020-06-09 10:23:35
*/
...
CREATE TABLE `diningcar` (
  ...
  KEY `dingingcar-user` (`userid`) USING BTREE,
  KEY `diningcar-food` (`foodid`) USING BTREE,
...
INSERT INTO `diningcar` VALUES ('16', '4', '9');
INSERT INTO `diningcar` VALUES ('17', '4', '5');
...
CREATE TABLE `food` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique-foodname` (`foodname`) USING BTREE,
  KEY `food-foodtype` (`type`) USING BTREE,
...
-- Records of food
-- ----------------------------
INSERT INTO `food` VALUES ('1', '菠菜炒鸡蛋', '暂无', '主料：菠菜300克，鸡蛋3个，盐、料酒、葱末、姜末、味精、香油各适量。', '9', '1', 'images/jiachang/01.jpg', '1', '0');
INSERT INTO `food` VALUES ('2', '韭菜炒鸡蛋', '工艺：炒    口味：清香味', '主料：韭菜4两（约160克），大鸡蛋3只。\r\n', '8', '1', 'images/jiachang/02.jpg', '0', '-1');
...
INSERT INTO `food` VALUES ('44', '啊哈', '测试', '大口吃肉', '15', '1', 'images/newfood/1591090606496.png', '5', '0');
...
CREATE TABLE `foodtype` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `unique-typename` (`typename`) USING BTREE
...
INSERT INTO `foodtype` VALUES ('7', '川菜');
INSERT INTO `foodtype` VALUES ('5', '湘菜');
INSERT INTO `foodtype` VALUES ('6', '粤菜');
...
CREATE TABLE `user` (
  ...
  `ident` char(1) NOT NULL COMMENT '0普通用户\r\n1管理员',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'admin', '123', '1', '84832000', '大连东软信息学院');
INSERT INTO `user` VALUES ('2', 'parker', '129sdx', '0', '84835000', '玉林路');
...
INSERT INTO `user` VALUES ('5', '周瑜', 'zhouyu', '0', '54123', '江东柴桑');
INSERT INTO `user` VALUES ('6', '孙权', 'sunquan', '0', '54125123', '江东');
INSERT INTO `user` VALUES ('7', '刘璋', 'liuzhang', '0', '541845123', '西川益州');
INSERT INTO `user` VALUES ('8', '曹仁', 'CAOREN', '0', '541840236', '中原许昌');
INSERT INTO `user` VALUES ('9', '司马懿', 'simayi', '0', '0236840236', '许昌');
INSERT INTO `user` VALUES ('10', '魏延', 'weiyan', '0', '02369840236', '荆州');
INSERT INTO `user` VALUES ('11', '赵云', 'zhaoyun', '0', '089635236', '荆州');
INSERT INTO `user` VALUES ('12', '荀彧', 'xunyu', '0', '089635236', '许昌');
INSERT INTO `user` VALUES ('13', 'zhouhailin0218', '963258', '0', '131878', '东软三期十六号公寓A座');
INSERT INTO `user` VALUES ('14', 'Halen-Lin', '365', '1', '84831234', '四川省');
INSERT INTO `user` VALUES ('15', '舒傲寒', '75450s', '0', '13184326596', '奋进街十二号');
